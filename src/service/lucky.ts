...
export async function luckyWheelGet(data: any) {
  return axios
    .post(`/tenant/assessment/interaction-games/getByC`, data)
    .then(response=> {
      if (response.data) {
...
export async function luckyWheelPlay(data: any) {
  return axios
    .post(`/tenant/assessment/interaction-games/play`, data)
    .then(response=> {
      if (response.data) {
        return response.data;
      }
...
export async function luckyWheelUserPrizeList(data: any) {
  return axios
    .post(`/tenant/assessment/interaction-games/getUserPrizeList`, data)
    .then(response=> {
      if (response.data) {
        return response.data;
      }
